...
$items =
    [
        [
            "path_img" => "img/demo/authors/sunny.png",
            "name_technology" => "Sunny A. (UI/UX Expert)",
            "place" => "Lead Author",
            "e-amil" => "@myplaneticket",
            "link" => "#",
        ],

        [
            "path_img" => "img/demo/authors/josh.png",
            "name_technology" => "Jos K. (ASP.NET Developer)",
            "place" => "Partner & Contributor",
            "e-amil" => "@atlantez ",
            "link" => "#",
        ],

        [
            "path_img" => "img/demo/authors/jovanni.png",
            "name_technology" => "Jovanni L. (PHP Developer)",
            "place" => "Partner & Contributor",
            "e-amil" => "@lodev09",
            "link" => "#",
        ],
        ...
        [
            "path_img" => "img/demo/authors/roberto.png",
            "name_technology" => "Roberto R. (Rails Developer)",
            "place" => "Partner & Contributor",
            "e-amil" => "@sildur ",
            "link" => "#",
        ]
